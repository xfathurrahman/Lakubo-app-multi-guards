...
<div class="md:flex md:justify-between p-4 bg-white">
    ...
    <div class="grid grid-cols-4 gap-12 text-center mt-3">
        <div class="mx-4 col-span-2">
            ...
            <ul class="text-gray-600 dark:text-gray-400">
                <li class="mb-4">
                    <a href="https://flowbite.com/" class="hover:underline">+6287785523796</a>
                </li>
                <li>
                    <a href="https://tailwindcss.com/" class="hover:underline">Contact@lakubo.com</a>
                </li>
            </ul>
        </div>
        <div class="mx-4 col-span-2">
...
<hr class="border-t-4 m-0 border-gray-200 sm:mx-auto dark:border-gray-700">

<div class="sm:flex sm:items-center sm:justify-between p-6 bg-white">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">LAKUBO™</a>. All Rights Reserved.
        </span>
